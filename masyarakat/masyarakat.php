...
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-danger p-2 shadow">
...
<?php 
  ...
  <div class="container-fluid justify-content-between d-flex p-5 flex-row-reverse align-self-start" id="hero">
    <div class="hero col-6">
    </div>
    <div class="header col-6 " style="color: #eee;">
      <h1 class="fs-1 fw-bolder text-light">Halo, <?php echo"$_SESSION[nama]"; ?></h1>
      <h2 class="fs-4">Selamat datang di <b>Kantor LOORAH</b>,<br>Mau lapor pengaduan? Langsung klik tombol dibawah aja cuy</h2>
