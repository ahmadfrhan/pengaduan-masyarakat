    ...
    <table border="1" cellpadding="5px" class="table text-center table-bordered border-danger table-hover">
        ...
        <tbody>
            <?php foreach ($laporan as $row) : ?>
                ...
                <td class="align-middle"><?= $row["username_farhan"]; ?></td>
                <td class="align-middle"><?= $row["password_farhan"]; ?></td>
                <td class="align-middle"><?= $row["telp_farhan"]; ?></td>
            </tr>
                <?php endforeach; ?>
        </tbody>
